...
import { navigatorState } from "../../store/src/atoms/navigator"
...
export default function NavBar() {
    ...
    async function changeCurrentTab(tabName: string) {
        await setCurrentActiveTab(tabName)
                                ...
                                {navigation.map((item) => (
                                    <Link href={item.href}
                                        ...
                                        className={classNames(
                                            item.name == currentActiveTab ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white',
                ...
                <div className="space-y-1 px-2 pb-3 pt-2">
                    {navigation.map((item) => (
                        <DisclosureButton
                            ...
                            as="a"
                            href={item.href}
                            aria-current={item.name == currentActiveTab ? 'page' : undefined}
                            className={classNames(
                                item.name == currentActiveTab ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white',
